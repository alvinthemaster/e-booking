...
class BookingProvider with ChangeNotifier {
  ...
  Future<void> selectRoute(Route route) async {
    try {
      debugPrint('📍 Route selected: ${route.name} (ID: ${route.id})');
  ...
  Future<void> loadVansForRoute(String routeId) async {
    try {
      ...
      debugPrint('🚐 Loading vans for route: $routeId');
      ...
      debugPrint('✅ Found ${_vans.length} boarding vans for route $routeId');
    } catch (e) {
      _errorMessage = e.toString();
      debugPrint('❌ Error loading vans for route: $e');
    } finally {
      _isLoading = false;
      notifyListeners();
    }
  ...
  Future<void> syncVansToRoutes({String? routeId}) async {
    try {
      ...
      debugPrint('✅ Vans synced to routes successfully');
    } catch (e) {
      _errorMessage = e.toString();
      debugPrint('❌ Error syncing vans to routes: $e');
