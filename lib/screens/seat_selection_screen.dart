...
class _SeatSelectionScreenState extends State<SeatSelectionScreen> {
            ...
            leading: IconButton(
              ...
              onPressed: () {
                ...
                if (Navigator.of(context).canPop()) {
                  ...
                  debugPrint('SeatSelection: Navigation stack corrupted, going to home');
                  Navigator.pushReplacementNamed(context, '/');
                }
              },
            ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildLegendItem('Selected', const Color(0xFF2196F3), Colors.white),
                    _buildLegendItem('Reserved', Colors.grey[400]!, Colors.grey[600]!),
                    _buildLegendItem('Discount', const Color(0xFF4CAF50), Colors.white),
                  ],
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                              ...
                              child: Container(
                                ...
                                child: const Center(
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.drive_eta, color: Colors.grey, size: 28),
                                      SizedBox(height: 4),
                                      Text(
                                        'Driver',
                                        style: TextStyle(
                                ...
                                children: [
                                  Expanded(
                                    child: _buildSeat(
                                      seatProvider.seats.firstWhere(
                                        (s) => s.id == 'D1A',
                                        orElse: () => Seat(id: 'D1A', row: 0, position: 'driver-right-window'),
                                      ),
                                      seatProvider,
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: _buildSeat(
                                      seatProvider.seats.firstWhere(
                                        (s) => s.id == 'D1B',
                                        orElse: () => Seat(id: 'D1B', row: 0, position: 'driver-right-aisle'),
                                      ),
                                      seatProvider,
                                    ),
                                  ),
                      ...
                      // Seats Layout
                      Expanded(
                        child: _buildVanSeatsLayout(seatProvider),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Text(_showBottomPanel ? 'Hide Details' : 'Show Details'),
                          ),
                        ],
                      ),
                      ...
                      if (_showBottomPanel) ...[
                        ...
                        _buildSummaryRow('Selected Seats:', '${seatProvider.selectedSeats.length}'),
                        _buildSummaryRowWithPeso('Regular Seats:', '${seatProvider.regularFareSeats} × ', seatProvider.baseFare.toStringAsFixed(0)),
                        if (seatProvider.discountedSeats > 0)
                          _buildSummaryRowWithPeso('Discounted Seats:', '${seatProvider.discountedSeats} × ', (seatProvider.baseFare * (1 - seatProvider.discountRate)).toStringAsFixed(0)),
                        const Divider(),
                        _buildSummaryRowWithPeso('Total Amount:', '', seatProvider.calculateTotalAmount().toStringAsFixed(2), isTotal: true),
                      ],
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => BookingFormScreen(
                                  ...
                                  totalAmount: seatProvider.calculateTotalAmount(),
                                  discountAmount: seatProvider.calculateDiscountAmount(),
                                ),
                              ),
                            );
                          },
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildSeat(
                      seatProvider.seats.firstWhere(
                        (s) => s.id == 'L${row}A',
                        orElse: () => Seat(id: 'L${row}A', row: row, position: 'left-window'),
                      ),
                      seatProvider,
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildSeat(
                      seatProvider.seats.firstWhere(
                        (s) => s.id == 'L${row}B',
                        orElse: () => Seat(id: 'L${row}B', row: row, position: 'left-aisle'),
                      ),
                      seatProvider,
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildSeat(
                      seatProvider.seats.firstWhere(
                        (s) => s.id == 'R${row}A',
                        orElse: () => Seat(id: 'R${row}A', row: row, position: 'right-aisle'),
                      ),
                      seatProvider,
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildSeat(
                      seatProvider.seats.firstWhere(
                        (s) => s.id == 'R${row}B',
                        orElse: () => Seat(id: 'R${row}B', row: row, position: 'right-window'),
                      ),
                      seatProvider,
                    ),
                  ),
  ...
  Widget _buildSummaryRowWithPeso(String label, String prefix, String amount, {bool isTotal = false}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 4.0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
