...
class VanSeatLayout extends StatelessWidget {
  ...
  /// that a document delivery is attached to this trip.  Seat taps still
  /// work normally for regular bookings.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Van Seats Layout - 4 rows with 2-2 configuration
        Expanded(
          child: Column(
            children: [
